...
/obj/effect/decal/cleanable/crayon/New(loc,age,icon_state,color,dir,pixel_x,pixel_y,main = "#FFFFFF",shade = "#000000",var/type = "rune")
	...
	switch(type) //For generics
		if("rune")
			type = "rune[rand(1,6)]"
		if("graffiti")
			type = pick("amyjon","face","matt","revolution","engie","guy","end","dwarf","uboa","heart","borgsrogue","shitcurity","catbeast","voxpox","security","hieroglyphs[rand(1,3)]","nanotrasen","lie","syndicate[rand(1,2)]","lambda","50bless","chaos", "twilight_cm", "starlight_cm", "rarity_cm", "rainbow_cm", "pinkie_cm", "luna_cm", "celestia_cm", "minuette", "iwtcird", "fluttershy_cm", "amethyst", "applejack_cm", "trixie_cm")
